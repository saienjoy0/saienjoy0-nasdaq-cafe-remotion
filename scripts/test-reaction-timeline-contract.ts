...
const legacy = cloneTestValue(valid);
...
const mismatch = cloneTestValue(valid);
...
const forbiddenSeries = cloneTestValue(valid);
...
const missingValue = cloneTestValue(valid);
...
const unsorted = cloneTestValue(valid);
...
const markerOutside = cloneTestValue(valid);
...
const majorShift = cloneTestValue(valid);
