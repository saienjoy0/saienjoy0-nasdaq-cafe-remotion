...
export const VISUAL_TEMPLATE_CONTRACTS: Record<VisualTemplateId, VisualTemplateContract> = {
  ...
  "split-comparison": {family: "split", supportedScreenStates: ["Data", "Chart", "MainWithEntity"], variants: ["two-lane", "left-to-right"], cards: range(0, 2), numbers: range(0, 4), nodes: range(0, 0), arrows: range(0, 0), requiresNumericValue: false},
  ...
  "verification-matrix": {family: "verification", supportedScreenStates: ["Data", "Chart"], variants: ["strengthen-vs-weaken", "reported-sequence"], cards: range(0, 4), numbers: range(0, 0), nodes: range(0, 4), arrows: range(0, 3), requiresNumericValue: false},
